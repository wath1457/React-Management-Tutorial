            ...
            <div>
                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <br/>
                        <TextField label="이름" type="text" name="userName" defaultValue={this.state.userName} onChange={this.handleValueChange}/><br/>
                        ...
                        <TextField label="직업" type="text" name="job" defaultValue={this.state.job} onChange={this.handleValueChange}/><br/>
                    </DialogContent>
                    <DialogActions>
